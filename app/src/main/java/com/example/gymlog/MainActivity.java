...
public class MainActivity extends AppCompatActivity {
    ...
    private void loginUser(Bundle savedInstanceState) {
        ...
        loggedInUserId = sharedPreferences.getInt(getString(R.string.preference_user_key), LOGGED_OUT);
    ...
    private void updateSharePreference(){
        ...
        sharedPrefEditor.putInt(getString(R.string.preference_user_key),loggedInUserId);
